...
images_dir=input_dir;
    ...
    for im = images'
        ...
        imsalt=imresize(imsalt,[600 600]);
        imgaus=imresize(imgaus,[600 600]);
        imspec=imresize(imspec,[600 600]);
        imnongaus=imresize(imnongaus,[600 600]);
        ...
        imwrite(image,strcat(out_dir,'\4_',im.name));
    end
